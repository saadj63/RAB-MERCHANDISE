...
<div id="transReceiptToPrint">
    <div class="row">
        <div class="col-xs-12 text-center text-uppercase">
            <center style='margin-bottom:5px'><img src="<?=base_url()?>public/images/logo.jpg" alt="logo" class="img-responsive" width="45px"></center>
            <b>RAB Enterprise</b>
            <div>Khanjire Mala Ichalkaranji</div>
        </div>
    </div>
    ...
    <br>
    <div class="row">
        <div class="col-xs-12 text-center">Thanks You !</div>
    </div>
</div>
