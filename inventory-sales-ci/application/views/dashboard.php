    ...
    <div class="col-sm-3">
        <div class="panel panel-info">
            <div class="panel-body latestStuffsBody" style="background-color:#795548">
                <div class="pull-left"><i class="fa fa-inr"></i></div>
                <div class="pull-right">
...
<div class="row margin-top-5">
    ...
    <div class="col-sm-3">
        <div class="panel panel-hash">
            <div class="panel-heading"><i class="fa fa-inr"></i> HIGHEST EARNING</div>
    ...
    <div class="col-sm-3">
        <div class="panel panel-hash">
            <div class="panel-heading"><i class="fa fa-inr"></i> LOWEST EARNING</div>
