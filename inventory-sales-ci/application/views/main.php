...
<html>
    ...
    <body>
        <nav class="navbar navbar-default hidden-print" style=height:70px>
            <div class="container-fluid">
                ...
                <div class="navbar-header" >
                    ...
                    <a class="navbar-brand" href="<?=base_url()?>" style="margin-top:-15px">
                        ...
                        <img src="<?=base_url()?>public/images/logo.jpg" alt="logo" class="img-responsive" width="50px" height="5px ">
                
                    </a>
                    <a class="navbar-brand" href="" style="margin-top:-20px;margin-left: 20px; color:darkblue; font-weight: bolder; font-family: sans-serif; ">
            <h1>RAB Merchandise </h1>    
                    </a>
        ...
        <footer class="container-fluid text-center hidden-print">
            <p>
                ...
                Developed By Saad Jamadar| <?=date('Y')?>
            </p>
        </footer>
